...
function Department() {
                ...
                <form id="manage-depart-form" class="popup-form">
                    <div class="form-row">
                        <div class="form-column">
                            ...
                            <input type="text" name="DepartName" class="swal2-input" value="${departmentData.Name || ""
				}" required />
                        </div>
                    </div>
                </form>
	...
	const submitEditDepartment = async (departmentData) => {
		try {
			await axios.put(
				"http://localhost:8080/api/editdepartment",
				departmentData
			);
	...
	const handleDeleteDepartment = async (departmentId) => {
		...
		if (isConfirmed) {
			try {
				await axios.delete("http://localhost:8080/api/deldepartment", {
